...
hi! ColorColumn cterm=NONE ctermbg=235 guibg=#272716
hi! CursorColumn cterm=NONE ctermbg=235 guibg=#272716
hi! CursorLine cterm=NONE ctermbg=235 guibg=#272716
...
hi! CursorLineNr cterm=NONE ctermbg=237 ctermfg=253 guibg=#4d4d22 guifg=#e2e2be
...
hi! Folded ctermbg=235 ctermfg=245 guibg=#272716 guifg=#93935c
hi! FoldColumn ctermbg=235 ctermfg=239 guibg=#272716 guifg=#68683a
hi! Function ctermfg=110 guifg=#5a79ba
hi! Identifier cterm=NONE ctermfg=109 guifg=#89c3eb
hi! Include ctermfg=110 guifg=#5a79ba
hi! LineNr ctermbg=235 ctermfg=239 guibg=#272716 guifg=#68683a
...
hi! Pmenu ctermbg=236 ctermfg=251 guibg=#3d425b guifg=#afafb0
...
hi! SignColumn ctermbg=235 ctermfg=239 guibg=#272716 guifg=#68683a
...
hi! ALEErrorSign ctermbg=235 ctermfg=203 guibg=#272716 guifg=#d9333f
hi! ALEWarningSign ctermbg=235 ctermfg=216 guibg=#272716 guifg=#ee7800
hi! ALEVirtualTextError ctermfg=203 guifg=#d9333f
hi! ALEVirtualTextWarning ctermfg=216 guifg=#ee7800
hi! GitGutterAdd ctermbg=235 ctermfg=150 guibg=#272716 guifg=#3eb370
hi! GitGutterChange ctermbg=235 ctermfg=109 guibg=#272716 guifg=#89c3eb
hi! GitGutterChangeDelete ctermbg=235 ctermfg=109 guibg=#272716 guifg=#89c3eb
hi! GitGutterDelete ctermbg=235 ctermfg=203 guibg=#272716 guifg=#d9333f
...
if has('nvim')
  ...
  let g:terminal_ansi_colors = ['#272716', '#d9333f', '#3eb370', '#ee7800', '#5a79ba', '#65318e', '#89c3eb', '#afafb0', '#4d4398', '#e2434e', '#44c67b', '#ff8408', '#6685c6', '#7332a6', '#9bcef1', '#b8b8c0']
endif
